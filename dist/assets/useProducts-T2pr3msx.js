import{u as a,a as d}from"./useMutation-wRGvQ37d.js";import{n as f,s}from"./index-DJa8JmTm.js";function p({page:t=1,pageSize:r=12,searchQuery:e}={}){return a({queryKey:["products",{page:t,pageSize:r,searchQuery:e}],queryFn:async()=>{const u=(t-1)*r,n=u+r-1;let o=s.from("products").select(`
          *,
          category:categories(*),
